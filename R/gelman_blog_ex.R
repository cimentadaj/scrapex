##' This example hosts data from the website https://statmodeling.stat.columbia.edu/, the blog
##' of statistician Andrew Gelman
##'
...
##'
##' @title Return the paths to the complete HTML website of the blog of Andrew Gelman
...
##' }
##'
gelman_blog_ex <- function() {
  pkg_dir <- system.file(package = "scrapex")
  dir_data <- file.path(pkg_dir, "extdata", "gelman_blog/stats/")
